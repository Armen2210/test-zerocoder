...
def generate_content(topic: str):
    ...
    try:
        ...
        post_content = openai.ChatCompletion.create(
            ...
            messages=[{
                "role": "user", 
                "content": f"""Ты — профессиональный журналист. Напиши статью на тему "{topic}", используя актуальные новости:\n{recent_news}
                Требования:
                - Пиши живо, естественно, как человек
                - Без шаблонов вроде «в этой статье мы рассмотрим»
                - Заголовки можно, но без символов #, и как будто ты пишешь статью для блога
                - Используй структуру: вступление, 2–3 смысловых раздела, заключение
                - Добавляй примеры из новостей, но не пиши сухо
                - Старайся писать с легким авторским стилем                  
